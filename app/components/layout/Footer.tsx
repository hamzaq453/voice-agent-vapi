      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-blue-400">PlumbAssist</h3>
            <p className="mt-4 text-gray-300 max-w-md">
              The virtual receptionist platform designed specifically for plumbers. Never miss a call or appointment again.
            </p>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
            &copy; {new Date().getFullYear()} PlumbAssist. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
